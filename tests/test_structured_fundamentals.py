...
class StructuredFundamentalTests(unittest.TestCase):
    ...
    def test_frequentis_parser(self):
        ...
        self.assertEqual(x['revenue']['value'],342900000);self.assertEqual(x['order_intake']['value'],361700000);self.assertEqual(x['ebit']['value'],15600000);self.assertEqual(x['backlog']['value'],835000000)
    def test_ivu_parser(self):
        ...
        self.assertEqual(x['revenue']['value'],72072000);self.assertEqual(x['gross_profit']['value'],59171000);self.assertEqual(x['ebit']['value'],3304000)
    def test_lagercrantz_parser(self):
        ...
        self.assertEqual(x['revenue']['value'],2907000000);self.assertEqual(x['ebita']['value'],498000000);self.assertEqual(x['ebita_margin']['value'],17.1);self.assertEqual(x['operating_cash_flow']['value'],279000000)
