...
def test_release_exposes_income_capability_without_new_provider():
    ...
    assert "Portfolio Intelligence · v8.7.60" in html
    assert "parqet-supabase-adapter.js?v=20260913-entry1" in html
    assert "app.js?v=20260913-entry1" in html
    assert "version:'8.7.60'" in runtime
    assert 'parqetIncome:true' in API
    assert 'version:"0.5.8"' in API
