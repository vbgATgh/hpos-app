...
marker='<script src="./alpha441.js"></script>';ins=marker+'\n<script src="./alpha442.js"></script>'
...
if changed:p.write_text(t,encoding='utf-8');print('Alpha 4.4.2 Architecture Runtime integriert.')
else:print('Alpha 4.4.2 bereits korrekt integriert.')
