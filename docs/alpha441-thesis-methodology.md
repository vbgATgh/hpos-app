...
4. **Fundamentale Qualität:** Wachstum, Cashflow, Bewertung, Stabilität, Dividende, Schulden. Frühere HPOS-Orientierung 25/20/20/15/10/5 wird als Diagnoseprofil geführt, nicht als automatische Freigabe.
5. **Markt/Timing:** Momentum (5% Diagnoseanteil), Drawdown, 52W-Kontext und Kaufzone. Momentum allein erzeugt nie ein Kaufsignal.
